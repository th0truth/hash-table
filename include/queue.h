...
// Constructor
template <class T>
Queue<T>::Queue(int32_t new_capacity): current_size(0), capacity(new_capacity), front_index(0), back_index(-1) 
{
  data = new T[capacity];
}
...
// Copy Constructor
template <class T>
Queue<T>::Queue(const Queue& other): current_size(other.current_size), capacity(other.capacity), front_index(other.front_index), back_index(other.back_index) 
{
  data = new T[capacity];
...
// Move Constructor
template <class T>
Queue<T>::Queue(Queue&& other): current_size(other.current_size), capacity(other.capacity), front_index(other.front_index), back_index(other.back_index), data(other.data) 
{
  other.data = nullptr;
